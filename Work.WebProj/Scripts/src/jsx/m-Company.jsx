	...
	render:function(){
		return (
				...
				<tr>
					...
					<td>{this.props.itemData.company_sn}</td>
...
var GirdForm = React.createClass({
	...
	getDefaultProps:function(){
		return{	
			fdName:'fieldData',
			gdName:'searchData',
			apiPathName:gb_approot+'api/Company'
		};
	},	
	...
	deleteSubmit:function(e){
		...
		for(var i in this.state.gridData.rows){
			if(this.state.gridData.rows[i].check_del){
				ids.push('ids='+this.state.gridData.rows[i].company_id);
			}
		}
			...
			<div>
				...
				<form className="form form-sm" onSubmit={this.handleSubmit}>
					<div className="form-group row">
						<label className="col-xs-2 form-control-label text-xs-right"><span className="text-danger">*</span> 公司名稱</label>
						<div className="col-xs-4">
							<input type="text" 							
							className="form-control"	
							value={fieldData.company_name}
							onChange={this.changeFDValue.bind(this,'company_name')}
							maxLength="16"
							required />
						</div>
					</div>
					<div className="form-group row">
						<label className="col-xs-2 form-control-label text-xs-right"><span className="text-danger">*</span> 公司代號</label>
						<div className="col-xs-4">
							<input type="text" 							
							className="form-control"	
							value={fieldData.company_sn}
							onChange={this.changeFDValue.bind(this,'company_sn')}
							maxLength="4"
							required />
						</div>
					</div>					
					<div className="form-group row">
						<label className="col-xs-2 form-control-label text-xs-right">狀態</label>
						<div className="col-xs-4">

...
var GirdForm = React.createClass({
    ...
    getInitialState: function () {
        return {
            ...
            fieldData: {},
            matters: {
                start_meal: { breakfast: [], lunch: [], dinner: [] },
			                    ...
			                    return (
                                    <span key={meal_diet.dietary_need_id}>
			                            ...
			                            meal_diet.meal_id.map(function (meal_id, i) {
			                                return (
			                                	<span key={'breakfast-' + meal_diet.dietary_need_id + '-' + meal_id}>
			                ...
			                itemData.meal_diet.map(function (meal_diet, i) {
			                    return (
                                    <span key={meal_diet.dietary_need_id}>
			                            ...
			                            meal_diet.meal_id.map(function (meal_id, i) {
			                                return (
			                                	<span key={'lunch-' + meal_diet.dietary_need_id + '-' + meal_id}>
			                                		<span className="label label-lg label-warning">{meal_id}</span> { }
			                                	</span>);
			                            }.bind(this))
                                        }
			                ...
			                itemData.meal_diet.map(function (meal_diet, i) {
			                    return (
                                    <span key={meal_diet.dietary_need_id}>
			                            ...
			                            meal_diet.meal_id.map(function (meal_id, i) {
			                                return (
			                                	<span key={'dinner-' + meal_diet.dietary_need_id + '-' + meal_id}>
			                                		<span className="label label-lg label-warning">{meal_id}</span> { }
			                                	</span>);
			                            }.bind(this))
                                        }

...
var ReactTypeahead = (function (_super) {
    ...
    ReactTypeahead.prototype.render = function () {
        ...
        return (React.createElement("div", {className: this.props.divClass}, React.createElement("input", {className: this.props.inputClass, type: "text", value: this.state.keyword, onChange: this.onChange, onKeyDown: this.keyDown, disabled: this.props.disabled, placeholder: this.props.placeholder}), out_selector));
    };

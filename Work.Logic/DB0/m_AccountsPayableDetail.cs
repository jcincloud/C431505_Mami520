...
namespace ProcCore.Business.DB0
{
    ...
    public partial class m_AccountsPayableDetail :BaseEntityTable {
    public int accounts_payable_detail_id { get; set; }
    public int accounts_payable_id { get; set; }
    public System.DateTime receipt_day { get; set; }
    public int meal_type { get; set; }
    public int receipt_person { get; set; }
    public int receipt_item { get; set; }
    public string receipt_sn { get; set; }
    public double actual_receipt { get; set; }

...
namespace ProcCore.Business
{
    ...
    {
        Base, Customer, CustomerBorn, Product, ProductRecord, ElementFood, ConstituteFood, DailyMenu, DietaryNeed, CustomerNeed, Activity, Draft, All_Category_L1, All_Category_L2
    }
    public enum SNType
    {
